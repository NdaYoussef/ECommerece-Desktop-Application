...
namespace ECommerece.Presentation.Forms.ProductForms
{
    public class ProductsForm : BaseForm
    {
        ...
        private void BuildProductsPage()
        {
            ...
            dgvProducts.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(59, 91, 219);
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Open Add Product form here.", "Add Product",
                MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        private void DgvProducts_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            if (e.ColumnIndex != dgvProducts.Columns["Status"].Index || e.Value == null) return;

            e.CellStyle.Font = new Font("Segoe UI", 9f, FontStyle.Bold);
            switch (e.Value.ToString())
            {
                case "In Stock":     e.CellStyle.ForeColor = Color.FromArgb(16, 185, 129); break;
                case "Low Stock":    e.CellStyle.ForeColor = Color.FromArgb(245, 158, 11); break;
                case "Out of Stock": e.CellStyle.ForeColor = Color.FromArgb(239, 68, 68);  break;
            }
        }

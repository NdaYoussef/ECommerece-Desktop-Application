...
namespace ECommerece.Presentation.Forms.OrderForms
{
    public class AdminOrderManagementForm : Form
    {
        ...
        public AdminOrderManagementForm(
        ...
        private void InitializeComponents()
        {
            ...
            lblAdminName.Location = new Point(
                mainPanel.Width - lblAdminName.PreferredWidth - 55,
                15
            );
            ...
            orderItemsCard.Paint += (s, e) =>
            {
                using (Pen pen = new Pen(Color.FromArgb(218, 226, 240), 1))
                    e.Graphics.DrawRectangle(
                        ...
                        0,
                        0,
                        orderItemsCard.Width - 1,
                        orderItemsCard.Height - 1
                    );
            };
            ...
            updateStatusCard.Paint += (s, e) =>
            {
                using (Pen pen = new Pen(Color.FromArgb(218, 226, 240), 1))
                    e.Graphics.DrawRectangle(
                        ...
                        0,
                        0,
                        updateStatusCard.Width - 1,
                        updateStatusCard.Height - 1
                    );
            };
        ...
        private Color GetBadgeBg(string s) =>
            s switch
            {
        ...
        private Color GetBadgeFg(string s) =>
            s switch
            {
        ...
        private void LoadOrderItems(OrderDto order)
        {
            ...
            string customerName = order.user?.Name ?? order.user?.Email ?? "Customer";
            lblOrderItemsCustomer.Text = $"Customer: {customerName}";
        ...
        private async void BtnUpdateStatus_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show(
                    $"Order #{_selectedOrder.Id} updated to \"{newStatus}\" successfully.",
                    "Success",
                    MessageBoxButtons.OK,
        ...
        private void PopulateGrid()
        {
            ...
            {
                dgvOrders.Invoke(new Action(PopulateGrid));
                return;
            }
